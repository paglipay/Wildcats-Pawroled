    ...
    return (<>
        <Carousel>
            <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                    <h3>You have the right to remain adorable</h3>
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption>
                    <h3 style={{textAlign:'left', fontSize: '35px'}}>The Paw-Leash Department (PLD)</h3>
        ...
        </section><section  className="section section-icons grey lighten-4 center">
            <h1>Top Most Wanted</h1>
        </section>
        <section style={{ backgroundColor: '#f4f4f4' }} className="section section-icons grey lighten-4 center">
            <Container style={{ height: '100%' }}>
